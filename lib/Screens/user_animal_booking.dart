...
class UserAnimalBooking extends StatefulWidget {
  const UserAnimalBooking({super.key});

  @override
  State<UserAnimalBooking> createState() => _UserAnimalBookingState();
}

class _UserAnimalBookingState extends State<UserAnimalBooking> {
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(
                                vertical: 4, horizontal: 0),
                            child: Text(
                              'No of Animals: ${document['num_of_animals']}',
                              textAlign: TextAlign.start,
                              overflow: TextOverflow.clip,
                              style: const TextStyle(
                                fontWeight: FontWeight.w400,
